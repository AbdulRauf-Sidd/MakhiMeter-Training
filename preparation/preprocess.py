...
input_folder = '/home/abdulrauf/Projects/makhi_meter_dataset/version/training/perfect/'
target_size = (256, 256)
...
output_folder = 'version/training/perfect binary/'
...
for file in files:
    ...
    _, binary_image = cv2.threshold(gray_image, 16, 255, cv2.THRESH_BINARY)
