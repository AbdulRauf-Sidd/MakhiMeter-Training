...
def label_encode_image(file_path, label_mapping):
    ...
    output_path = '/home/abdulrauf/Projects/MakhiMeter-Training/data/brain/labeled encoded/' + os.path.basename(file_path)
...
input_folder = '/home/abdulrauf/Projects/MakhiMeter-Training/data/brain/masked aug 2/'
